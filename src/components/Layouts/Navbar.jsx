...
const Navbar = () => {
  ...
  const nav = <>
    ...
    <li className="relative text-gray-700 font-sans text-lg" ref={pagesRef}>
      <button
      ...
      {/* Dropdown Menu */}
      {showPages && (
        <ul className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl z-50
                       animate-fadeIn">
          <li>
            <Link
              href="/Compare"
